	...
	<div class="container">
		<div class = "footer-block">
			<div class = "footer-logo-wrapper">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-2.png" alt="Salvation Auto Logo" class="footer-logo">
			</div>
			<p>
			...
			<div class="footer-links">
				<a href="tel:+1234567890">
					...
					<span class="contact-icon">
						<img 
						src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/phone.svg" 
						alt="Phone Icon"
						class="contact-icon"
					>
					</span>
				...
				<a href="mailto:info@salvationauto.com">
					...
					<span class="contact-icon">
						<img 
						src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/email.svg" 
						alt="Email Icon"
						class="contact-icon"
					>
					</span>
				...
				<a href="https://goo.gl/maps/yourlocation" target="_blank">
					...
					<span class="contact-icon">
						<img 
						src="<?php echo get_template_directory_uri(); ?>/assets/images/svg/location.svg" 
						alt="Location Icon"
						class="contact-icon"
					>
					</span>
